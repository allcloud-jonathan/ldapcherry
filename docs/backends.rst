...
+--------------------------+----------+------------------------------------+--------------------------+--------------------------------------------+
| userdn_base              | backends | the base of the DN for users       | defaults to 'CN=Users,'  | the string must end with a comma           |
+--------------------------+----------+------------------------------------+--------------------------+--------------------------------------------+
| groupdn_base             | backends | the base of the DN for groups      | defaults to 'CN=Users,'  | the string must end with a comma           |
+--------------------------+----------+------------------------------------+--------------------------+--------------------------------------------+
